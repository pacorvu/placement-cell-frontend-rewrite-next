...
const sidebarItems = [
  ...
  { id: 'certifications', label: 'Certifications', hasData: false, addable: true },
    ...
    <div className="min-h-screen bg-base-100">
        ...
        <div className="navbar max-w-7xl mx-auto px-4">
          ...
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1">
              ...
              <li><Link href="/student/profile" className="active">Profile</Link></li>
      ...
      <div className="flex max-w-7xl mx-auto flex-col lg:flex-row">
        ...
        <aside className="w-full lg:w-64 bg-base-200 border-r border-base-300">
          <div className="p-4">
            <h2 className="text-sm font-bold text-base-content/60 uppercase mb-4">Profile Sections</h2>
        ...
        <main className="flex-1 p-8">
            ...
            <div className="card-body">
              <div className="flex items-start justify-between flex-wrap gap-4">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-base-content">Student Name</h1>
              ...
              <div className="card-body">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="form-control">
                    ...
                    <select className="select select-bordered" disabled={!isEditing}>
                ...
                <h3 className="font-bold text-base-content mb-4">Academic Identity</h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {['School Name', 'Year of Joining', 'Program', 'Specialization', 'Major', 'Minor'].map((field) => (
            ...
            <div className="card bg-base-100 shadow border border-base-300">
              <div className="card-body text-center py-16">
                <h3 className="text-xl font-bold text-base-content mb-2">
                  No {sidebarItems.find(item => item.id === activeSection)?.label} Added
                </h3>
                <p className="text-base-content/60 mb-6">
                  Start building your profile by adding your {sidebarItems.find(item => item.id === activeSection)?.label.toLowerCase()}
                </p>
                <button className="btn btn-primary">
                  + Add {sidebarItems.find(item => item.id === activeSection)?.label}
                </button>
              </div>
            </div>
          )}
          ...
          {/* For other sections */}
          {!sidebarItems.find(item => item.id === activeSection)?.addable && activeSection !== 'personal' && (
            <div className="card bg-base-100 shadow border border-base-300">
              <div className="card-body">
                <div className="alert alert-info">
                  ...
                  <div>
                    ...
                    <div className="text-sm">Complete this section to improve your profile visibility to recruiters.</div>
                  </div>
                </div>
              </div>
            </div>
